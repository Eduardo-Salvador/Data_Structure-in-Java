...
## Why A_LinearStructures.b_Lists:
...
**Use A_LinearStructures.b_Lists when:**
...
**Avoid A_LinearStructures.b_Lists when:**

- You only need LIFO access (use a A_LinearStructures.c_Stacks)
