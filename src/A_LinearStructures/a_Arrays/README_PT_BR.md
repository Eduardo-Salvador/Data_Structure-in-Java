...
- **A_LinearStructures.a_Arrays armazenam de forma contínua na memória**, sendo assim **mesmo que tenhamos o exato espaço dísponivel na memória, se ele não estiver alinhado, não conseguira alocar.**
- **A_LinearStructures.a_Arrays aceitam apenas Objetos do mesmo tipo** na memória.
- A_LinearStructures.a_Arrays tem **tempo de leitura O(1) e Escrita O(n)** em sua grande maioria, pois devem deslocar todos elementos para escrever em um lugar que já exite algo.
- **A_LinearStructures.a_Arrays tem tamanho fíxo**, sendo assim podem ter elementos vazios, ou espaço insufíciente.
