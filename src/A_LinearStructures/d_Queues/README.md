...
## Why A_LinearStructures.d_Queues:
...
**Use A_LinearStructures.d_Queues when:**
...
**Avoid A_LinearStructures.d_Queues when:**

- You need LIFO access (use a A_LinearStructures.c_Stacks)
