package main.B_LinearStructures.b_Lists.LinkedCircularList;
import main.B_LinearStructures.z_Interfaces.DinamicStructure.NodeStructure;
import java.lang.reflect.Array;

public class LinkedCircularList<T> extends NodeStructure<T> {
    private Node<T> head;
    private Node<T> tail;
    ...
    public T removeLast() {
        ...
        if (this.size == 1) {
            ...
            Node<T> newTail = getNode(this.size - 2);
