...
- Usada em métodos da biblioteca padrão como `A_LinearStructures.a_Arrays.binarySearch()` e como sub-rotina em algoritmos como o particionamento do Quick Sort.
...
A_LinearStructures.a_Arrays.sort(array); // busca binária exige entrada ordenada
