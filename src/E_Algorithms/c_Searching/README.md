...
- Used in standard library methods such as `A_LinearStructures.a_Arrays.binarySearch()` and as a subroutine in algorithms like Quick Sort partitioning.
...
A_LinearStructures.a_Arrays.sort(array); // binary search requires sorted input
